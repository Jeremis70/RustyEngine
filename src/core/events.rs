...
pub enum Key {
    ...
    Space, Enter, Escape, Tab, Backspace, Delete, Left, Right, Up, Down, Home, End, PageUp, PageDown, Insert,
    ...
    MediaPlayPause, MediaStop, MediaNextTrack, MediaPrevTrack, VolumeUp, VolumeDown, VolumeMute, MediaSelect, Eject, Power, Sleep, WakeUp,

    BrowserBack, BrowserForward, BrowserRefresh, BrowserStop, BrowserSearch, BrowserFavorites, BrowserHome, LaunchMail, LaunchApp1, LaunchApp2,

    PrintScreen, Pause, Unknown,
    ...
    // IME / locale-specific
    Convert, NonConvert, KanaMode, Lang1, Lang2, Lang3, Lang4, Lang5,

    // Numpad additional keys
    NumPadBackspace, NumPadClear, NumPadClearEntry, NumPadComma, NumPadHash,
    NumPadMemoryAdd, NumPadMemoryClear, NumPadMemoryRecall, NumPadMemoryStore, NumPadMemorySubtract,
    NumPadParenLeft, NumPadParenRight, NumPadStar,
}
